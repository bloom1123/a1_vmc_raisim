...
vector<double> weights {1, 1, 0.2, 1000, 1000, 5}; /* NOLINT */
double mass = 12.454;

vector<double> inertia {0.01683993, 0.056579028, 0.064713601, 0, 0, 0};
...
VectorXd getCommand(double t) {
    ...
    MatrixXd speed_points {{vx, 0, 0, 0}, {vx, 0, 0, 0},{vx, 0, 0, 0},
...
int main() {
    //Construct simulator
//    std::string xmlPath ="/home/user/Documents/raisim_mpc/stairs.xml";
...
//    raisim::RaisimServer server(&world);
    ...
    //Create a1 class
    string urdf_path = "/home/user/Documents/raisim_vmc/a1_data/urdf/a1.urdf";
    auto model = world.addArticulatedSystem(urdf_path);
//    auto box1 = world.addBox(2,2,0.1, 100);
//    box1->setPosition(raisim::Vec<3>{2,0,0.4});
//    auto box2 = world.addBox(2.2,2,0.1, 100);
//    box2->setPosition(raisim::Vec<3>{2,0,0.3});
//    auto box3 = world.addBox(2.4,2,0.1, 100);
//    box3->setPosition(raisim::Vec<3>{2,0,0.2});
//    auto box4 = world.addBox(2.6,2,0.1, 100);
//    box4->setPosition(raisim::Vec<3>{2,0,0.1});
//    auto box5 = world.addBox(2.8,2,0.1, 100);
//    box5->setPosition(raisim::Vec<3>{2,0,0});
    ...
    // //Main loop
     while ((current_time - start_time) < max_time) {
         ...
         //Apply action
         auto hybrid_action = controller.getAction(mpc_step, weights,mass,inertia);
